...
type CollectionStep = { id: string; name: string; status: CollectionStatus; progressCount: number; errorMessage?: string | null; startedAt?: string | null; finishedAt?: string | null };
