...
Codex Agent Skills are maintained separately by the repository owner. The repository only reserves `.github/skills/` as their placement directory. Do not add or modify Skill contents unless explicitly requested.
